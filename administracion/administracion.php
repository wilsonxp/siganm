        ...
        <div id="wrapper"> 
            ...
            <section id="main" class="clearfix">
                ...
                <aside id="sidebar">
                    <h3>Administrador</h3>
                    <ul class="clearfix">
                        <li><a title="Clasificadores" href="clasificadores/clasificadores.php">Clasificadores</a></li>
                        <li><a title="Mallas" href="#">Mallas</a></li>
                        <li><a title="Matriculas" href="matriculas.php">Matriculas</a></li>
                        <li><a title="Profesores" href="#">Profesores</a></li>
                    </ul>
                </aside>
                <section  id="content">
                    <b>En esta seccion seleccione una opcion para continuar.</b>
                </section>
            </section>
