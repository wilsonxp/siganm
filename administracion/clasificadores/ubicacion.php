...
<html>
    <head>
        ...
        <title> CLASIFICADORES / UBICACION</title>
    </head>
    ...
    <body>
        <div id="wrapper"> 
            ...
            <section id="main" class="clearfix">
                ...
                <aside id="sidebar">
                    <h3>Administrador / Ubicacion</h3>
                    <ul class="clearfix">
                        <li><a title="Países" href="ubicacion/paises.php">Países</a></li>
                        <li><a title="Provincias" href="ubicacion/provincias.php">Provincias</a></li>
                        <li><a title="Ciudades" href="ubicacion/ciudades.php">Ciudades</a></li>                       
                        <li><a title="Sectores" href="ubicacion/sectores.php">Sectores</a></li>
                        <li><a title="Resgresar" href="clasificadores.php">Regresar</a></li>
                    </ul>
                </aside>
                <section  id="content">
