...
<html>
    <head>
        ...
        <title>ADMINISTRACION / CLASIFICADORES</title>
    </head>
    ...
    <body>
        <div id="wrapper"> 
            ...
            <section id="main" class="clearfix">
                ...
                <aside id="sidebar">
                    <h3>Administrador / Clasificadores</h3>
                    <ul class="clearfix">
                        <li><a title="Asignaturas" href="asignaturas.php">Asignaturas</a></li>
                        <li><a title="Profesiones" href="profesiones.php">Profesiones</a></li>
                        <li><a title="Titulos" href="titulos.php">Titulos</a></li>
                        <li><a title="Ubicacion" href="ubicacion.php">Ubicacion</a></li>
                        <li><a title="Resgresar" href="../administracion.php">Regresar</a></li>
                    </ul>
                </aside>
                <section  id="content">
