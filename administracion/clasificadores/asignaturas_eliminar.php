            ...
            <section id="main" class="clearfix">
                ...
                <section  id="content">
                    ...
                    <table width="500" border="1" cellpadding="2" cellspacing="2">
                        ...
                        <?php
                        $link   = conectarse();
                        $sql    = "select nombre, especialidad, asignatura.id from asignatura ";
                        ...
                        if ($row    = mysql_fetch_array($result))
                        {
                            ...
                            }do
                            {
                                ?>
                                <tr>
                                    <td><a href="asignaturas_eliminar_1.php?id=<?php echo$row[2]; ?>"><?php echo $row[0]; ?></a></td>
                ...
                <aside id="sidebar" style="margin-top: -86px;">
